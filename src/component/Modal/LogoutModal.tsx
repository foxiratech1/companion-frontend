                    ...
                    <div className="relative p-4 w-full max-w-md">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="p-4 md:p-5 text-center">
                                ...
                                <h3 className="mb-2 text-2xl font-albert font-semibold">Sorry, You're not logged in</h3>
                                <p className="mb-5 text-md text-gray-500">Sorry, you are not logged in. Please login.</p>
