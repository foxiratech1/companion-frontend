  ...
  return (
    <>
      <section className="bg-black relative h-[300px]">
        ...
        <button className="md:w-auto w-44 mt-10 mx-auto flex justify-center items-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-red-500 p-3 rounded-lg border border-red-600">
          CHANGE LOCATION
        </button>
      </section>
